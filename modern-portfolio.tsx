...
export default function ModernPortfolio() {
  ...
  const allEducation = [
    ...
    },
    {
      ...
      period: "2023",
      description:
        "Intensive 6-month program covering modern web technologies including React, Node.js, Python, and cloud deployment.",
      logo: "/tech-institute-logo.png",
    ...
    },
    {
      ...
      period: "2022",
      description:
        "Comprehensive online course covering advanced JavaScript concepts, React ecosystem, and modern development practices.",
      logo: "/online-platform-logo.png",
    ...
    },
    {
      ...
      logo: "/community-college-logo.png",
      gpa: "3.9/4.0",
      achievements: ["Valedictorian", "IT Student of the Year"],
    },
  ]
  ...
  const allExperience = [
    {
      ...
      period: "2024 - Present",
      description:
        "Developing scalable web applications using React, Node.js, and MongoDB. Led the development of a customer dashboard that increased user engagement by 40%.",
      ...
      achievements: ["Employee of the Month (June 2024)", "Led successful product launch"],
    },
    {
      company: "Freelance",
      ...
      period: "2023 - 2024",
      description:
        "Provided web development services to small businesses and startups, creating custom websites and web applications.",
      logo: "/freelance-logo.png",
      responsibilities: [
        "Developed custom WordPress themes and plugins",
        "Created e-commerce solutions using Shopify and WooCommerce",
        "Built landing pages with high conversion rates",
        "Provided ongoing maintenance and support",
      ],
      achievements: ["Completed 15+ successful projects", "100% client satisfaction rate"],
    },
    {
      company: "University IT Department",
      position: "Student Web Developer",
      period: "2022 - 2023",
      description: "Part-time position maintaining and updating university websites and internal tools.",
      logo: "/university-it-logo.png",
      responsibilities: [
        "Updated university website content using CMS",
        "Fixed bugs and implemented new features",
        "Assisted with database maintenance",
        "Provided technical support to faculty",
      ],
      achievements: ["Improved website load times by 30%", "Streamlined content update process"],
    },
  ]
          ...
          >
            <div className="relative w-96 h-96 mx-auto">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white/20 backdrop-blur-sm z-10">
                <img src="/BARAONG.png" alt="Professional Developer" className="w-full h-full object-cover" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { name: "Problem Solving", icon: "🧩", description: "Creative approach to complex challenges" },
                { name: "Team Collaboration", icon: "🤝", description: "Effective communication and teamwork" },
                { name: "Leadership", icon: "👑", description: "Guiding teams to achieve common goals" },
                { name: "Adaptability", icon: "🔄", description: "Quick learning and flexibility" },
                { name: "Critical Thinking", icon: "🎯", description: "Analytical and strategic mindset" },
                { name: "Communication", icon: "💬", description: "Clear and effective expression" },
                { name: "Time Management", icon: "⏰", description: "Efficient project and deadline handling" },
                { name: "Creativity", icon: "🎨", description: "Innovative solutions and design thinking" },
              ].map((skill, index) => (
                <motion.div
                  key={skill.name}
                  initial={{ opacity: 0, scale: 0 }}
